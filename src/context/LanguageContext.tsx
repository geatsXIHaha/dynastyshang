...
const translations = {
  cn: {
    ...
    home: {
      ...
      description: '中华文明的可考起点',
      description2: '让我们探索中国第一个有文字记载的朝代的故事与智慧',
      subtitle1:'前言',
      subtitle1_desc1:'商朝（公元前1600—1046年）是中国最早进入有文字记载的时代。青铜技术、早期文字、宗教祭祀体系和宏大的社会结构在此时期逐渐成熟，奠定了后世中华文明的根基。',
      subtitle1_desc2:'在夏代史料模糊、更多停留于传说背景的情况下，商朝凭借丰富的文字与青铜器考古成果，成为中国历史研究中第一个真正可被证实的王朝。亦成为了中国历史上的起头与开端。',
      subtitle1_desc3:'可见，文字在中国历史研究中的根本性作用不言而喻。',
      subtitle2:'关于商朝',
      subtitle2_desc1:'1. 最早成体系的文字',
      subtitle2_desc2:' ——甲骨文、金文初具规模，为研究政治、宗教与社会提供直接证据。',
      subtitle2_desc3:'2. 高度发展的青铜文明',
      subtitle2_desc4:' ——青铜器铸造技术领先同期文明，体现强大的礼制与工艺水平。',
      subtitle2_desc5:'3. 成熟的国家形态',
      subtitle2_desc6:' ——多次迁都、复杂宗族体系、严格祭祀制度，显示组织结构的高度发展。',
      subtitle2_desc7:'4. 活跃的畜牧与祭祀活动',
      subtitle2_desc8:' ——卜辞中记录大量祭牲，反映其信仰与祭天文化。',
      subtitle3:'本网页的目的',
      subtitle3_desc1:'本网页旨在通过甲骨文、金文及考古资料，为读者呈现一个准确清晰、基于证据的商代图景。',
      subtitle3_desc2:'您将在此了解商朝的起源、发展脉络、社会结构与文化特征。',
      subtitle4:'浏览',
      subtitle4_desc1:'成汤建国&灭夏: ',
      subtitle4_desc2:'了解商朝的起源、建立过程与早期政治背景。',
      subtitle4_desc3:'王係谱&年表: ',
      subtitle4_desc4:'掌握商王世系、年号与政权传承结构。',
      subtitle4_desc5:'商朝迁都： ',
      subtitle4_desc6:'解析商代屡次迁都的主流原因。',
      subtitle4_desc7:'商与周边部族关系: ',
      subtitle4_desc8:'理解商朝与周边族群的互动、联盟、冲突与文化联系。',
    },
    cp1: {
      title: '成汤建国&灭夏',
      subtitle1: '成汤灭夏的原因',
    ...
    cp2: {
      ...
      subtitle1: '商朝王系表',
      subtitle2: '商王——商朝帝王列表',
      desc2: '商朝的世系年代无定说, 前后相传17世31王, 延续600年左右',
      tableheader1:'次序',
      tableheader2:'日名1 (祭名)',
      tableheader3:'日名2 (祭名)',
      tableheader4:'庙号',
    ...
    cp3: {
      ...
      subtitle1: '关于迁都',
      subpoint1_desc1: '商朝与后来的历史时期相比有一个非常独特的地方，就是它的都城屡次迁徙。',
      subpoint1_desc2: '张衡在《东京赋》中说：“殷人屡迁，前八后五”，即商朝从契至汤期间迁徙了八次，自汤至盘庚期间迁徙了五次（中商阶段）。',
      subpoint1_desc3: '盘庚迁殷之后，商人的都城就再没有迁移过。',
      ...
      table_column2_cont1:'1. 第一次，仲丁迁于嚣（隞）。（今郑州中原)',
      table_column2_cont2:'2. 第二次，河亶甲居相。 (今安阳内黄)',
      table_column2_cont3:'3. 三次，祖乙都邢。(今河北邢台)',
      table_column2_cont4:'4. 第四次，南庚都奄。(今山东曲阜)',
      table_column2_cont5:'5. 第五次，盘庚迁殷。（今河南安阳）',
    ...
    cp4: {
      title: '​​商与方国的关系',
      desc1:'商代的西方方国有60个, 北方方国有8个, 东方方国有23个, 南方方国有12个, 地望待考方国有55个, 共计158个方国。',
      desc2:'可分为3种：',
      subtitle1:'1. 只与商王朝为敌',
      subtitle2:'2. 与商王朝时敌时友',
      subtitle2_desc1:'商时的羌族是游牧民族，而以羌族为主要部分的西戎也应以畜牧经济为主。',
      subtitle2_desc2:'他们的牲畜中，羊大概占有很大的比重，故以牧羊人而得名。',
      subtitle2_desc3:'武丁时的卜辞中， 除羌外，尚有北羌、多马羌等称。顾名思义，北羌以居于羌族北部而得名，多马羌以马多得名，都是羌族的一部分。',
      subtitle2_desc4:'商朝通过战争俘获大量羌人，包括首领“羌白”。',
      subtitle2_desc5:'一、用于祭祀的牺牲品；',
      subtitle2_desc6:'二、变为奴隶，用于生产。',
      subtitle2_desc7:'商人对羌用兵多于其他民族。',
      subtitle2_desc8:'以上反映商与羌族的关系密切，反映羌族力量的强大与对商朝存在的重要意义。',
      subtitle3:'3. 一直与商王朝为友',
      subtitle3_desc1:'晚商时期鬼方为商朝属国',
    },
    footer: {
  ...
  en: {
    ...
    home: {
      title: 'Welcome to the Shang Dynasty',
      subtitle: 'The First Verifiable Era of Chinese Civilization',
      description: 'Explore the stories and wisdom behind China’s earliest dynasty with written records.',
      description2: ' ',
      subtitle1:'Introduction',
      subtitle1_desc1:'The Shang Dynasty (1600–1046 BCE) marks China’s earliest era with reliable written documentation. During this period, bronze technology, early writing systems, state-level religious rituals, and a complex social structure matured, laying the foundation for later Chinese civilization.',
      subtitle1_desc2:'While historical accounts of the preceding Xia Dynasty remain vague and largely mythical, the Shang Dynasty stands out through its rich corpus of written records and archaeological discoveries, making it the first truly verifiable dynasty in Chinese history—often regarded as the real beginning of China\'s historical narrative.',
      subtitle1_desc3:'This highlights the fundamental importance of writing in the study of Chinese history.',
      subtitle2:'About the Shang Dynasty',
      subtitle2_desc1:'1. The Earliest Systematic Writing',
      subtitle2_desc2:'  — Oracle bone inscriptions and bronze inscriptions formed the earliest structured writing system, offering direct evidence of political, religious, and social practices.',
      subtitle2_desc3:'2. A Highly Developed Bronze Civilization',
      subtitle2_desc4:'  — Advanced bronze-casting techniques and exquisite ritual vessels reflect a sophisticated level of craftsmanship and ceremonial culture.',
      subtitle2_desc5:'3. A Mature State Structure',
      subtitle2_desc6:'  — Frequent capital relocations, intricate kinship networks, and elaborate ritual systems demonstrate an advanced political and social organization.',
      subtitle2_desc7:'4. Active Pastoralism and Ritual Sacrifice',
      subtitle2_desc8:' — Oracle bone records document extensive animal offerings, revealing the dynasty\'s belief systems and ritual traditions.',
      subtitle3:'Objective of This Website',
      subtitle3_desc1:'This website aims to present a clear and evidence-based picture of the Shang Dynasty through oracle bone inscriptions, bronze inscriptions, and archaeological findings.',
      subtitle3_desc2:'Here, you can explore the origins, development, social structure, and cultural characteristics of the Shang civilization.',
      subtitle4:'Navigation',
      subtitle4_desc1:'The Founding of the Shang & the Fall of Xia: ',
      subtitle4_desc2:'Learn about the origins of the Shang Dynasty, its establishment, and its early political background.',
      subtitle4_desc3:'Royal Genealogy & Chronology: ',
      subtitle4_desc4:'Understand the names, lineage, and succession of the Shang kings.',
      subtitle4_desc5:'Capital Relocations: ',
      subtitle4_desc6:'Explore the major reasons behind the Shang Dynasty\'s numerous capital migrations.',
      subtitle4_desc7:'Relations with Neighboring Tribes: ',
      subtitle4_desc8:'Examine the interactions, alliances, conflicts, and cultural exchanges between the Shang and surrounding groups.',
    },
    cp1: {
    ...
    cp2: {
      ...
      subtitle1: 'Shang Dynasty Kings List',
      subtitle2: 'Shang Kings — List of Monarchs of the Shang Dynasty',
      desc2: 'The chronology of the Shang kings is not definitively established. Traditionally, the dynasty is said to have passed down through 17 generations and 31 kings, lasting for approximately 600 years.',
      tableheader1:'Bil.',
      tableheader2:'Ritual Name 1',
      tableheader3:'Ritual Name 2',
      tableheader4:'Temple Name',
      tableheader5:'Personal Name',
      tableheader6:'Remarks',
      tableheader7:'Date (BCE)',
      tableheader8:'Duration (Years)',
      tabledesc1:'Early Shang Period',
      tabledesc2:'From Tang → Pan Geng (before the relocation to Yin)',
      tabledesc3:'Late Shang Period',
      tabledesc4:'From Pan Geng (after the relocation to Yin)',
    },
    cp3: {
      ...
      table_column2_cont1:'1.  Zhong Ding (仲丁) moved the capital to Ao (隞), located in Zhongyuan, Zhengzhou',
      table_column2_cont2:'2. He Dan Jia (河亶甲) moved the capital to Xiang (相), located in Neihuang, Anyang',
      table_column2_cont3:'3. Zu Yi (祖乙) moved the capital to Xing (邢), located in Xingtai, Hebei',
      table_column2_cont4:'4. Nan Geng (南庚) moved the capital to Yan (奄), located in Qufu, Shandong',
      table_column2_cont5:'5. Pan Geng (盘庚) moved the capital to Yin (殷), located in Anyang, Henan',
    ...
    cp4: {
      title: 'The relationship between the Shang & neighbouring states',
      desc1: 'In the Shang dynasty, there were 60 western states, 8 northern states, 23 eastern states, 12 southern states, and 55 states whose locations are still uncertain, making a total of 158 neighbouring states.',
      desc2:'They can be divided into three categories:',
      subtitle1:'1. Those who were always enemies of the Shang Dynasty',
      subtitle2:'2. Those who were sometimes enemies and sometimes allies of the Shang Dynasty',
      subtitle2_desc1:'The Qiang people during the Shang period were a nomadic group, and they rely primarily on animal husbandry.',
      subtitle2_desc2:'Among their livestock, sheep likely made up a large proportion, so they came to be known by a name that essentially means ‘shepherds.’',
      subtitle2_desc3:'The “Northern Qiang” were so called because they lived in the northern part of the Qiang, while the “Duoma Qiang” were named for their abundance of horses. Both groups were subdivisions of the larger Qiang population.',
      subtitle2_desc4:'The Shang dynasty captured large numbers of Qiang people through the war, including the leader ‘Qiang Bai’.',
      subtitle2_desc5:'1. Used as sacrificial offerings in rituals',
      subtitle2_desc6:'2. Turned into slaves and used for labour',
      subtitle2_desc7:'The Shang used the Qiang people as soldiers more than other ethnic groups.',
      subtitle2_desc8:'The above evidence reflects the close relationship between the Shang and the Qiang, highlighting the strength of the Qiang and their significant role in the Shang dynasty.',
      subtitle3:'3. Those who were always allies of the Shang dynasty',
      subtitle3_desc1:'During the late Shang period, the Guifang were a vassal state of the Shang dynasty.',
    },
    footer: {
