...
const translations = {
  cn: {
    ...
    cp4: {
      ...
      subtitle3_desc1:'通过以上分析，晚商时期鬼方为商朝属国，它为商王打仗、祭祀、捕获羌人、贡纳人牲与官吏。',
    },
    footer: {
  ...
  en: {
    ...
    cp4: {
      ...
      subtitle3_desc1:'Based on the above analysis, during the late Shang period, the Guifang were a vassal state of the Shang dynasty. They participated in wars and rituals, captured the Qiang people, and offered tribute in the form of humans and animals, as well as officials, to the Shang kings.',
    },
    footer: {
